...
void SFMLDebugDraw::DrawSegment(const b2Vec2 &p1, const b2Vec2 &p2, const b2Color &color) {
  sf::Vertex line[] = {sf::Vertex(SFMLDebugDraw::B2VecToSFVec(p1), SFMLDebugDraw::GLColorToSFML(color)),
...
void SFMLDebugDraw::DrawTransform(const b2Transform &xf) {
  ...
  sf::Vertex redLine[] = {sf::Vertex(SFMLDebugDraw::B2VecToSFVec(xf.p), sf::Color::Red),
  ...
  sf::Vertex greenLine[] = {sf::Vertex(SFMLDebugDraw::B2VecToSFVec(xf.p), sf::Color::Green),
